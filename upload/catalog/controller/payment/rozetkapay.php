...
class ControllerPaymentRozetkaPay extends Controller {
    ...
    public function confirm() {
        ...
        if ($this->session->data['payment_method']['code'] == 'rozetkapay') {
            ...
            $this->rpay->setResultURL($this->url->link($this->path.'/result', 'order_id=' . $order_id));
            $this->rpay->setCallbackURL($this->url->link($this->path.'/callback', 'order_id=' . $order_id));
            ...
            if ($status_holding) {
                ...
                $dataCheckout->callback_url = $this->url->link($this->path.'/callback', 'order_id=' . $order_id . "&holding");
                $dataCheckout->result_url = $this->url->link($this->path.'/result', 'order_id=' . $order_id . "&holding");
                list($result, $error) = $this->rpay->paymentCreate($dataCheckout);
